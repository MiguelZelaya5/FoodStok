...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE articulos (idarticulo INTEGER PRIMARY KEY AUTOINCREMENT, categoria VARCHAR(45), nombrearticulo VARCHAR(45), fechafabricacion DATE, fechacaducidad DATE, cantidad INTEGER, foto VARCHAR(100), id_usuario INTEGER, FOREIGN KEY (id_usuario) REFERENCES usuarios(idusuarios));");
    }
